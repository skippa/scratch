...
set laststatus=2
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/gruvbox,~/.vim/bundle/vim-css-color,~/.vim/bundle/nerdtree,~/.vim/bundle/coc.nvim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/gruvbox/after,~/.vim/bundle/vim-css-color/after,~/.vim/bundle/nerdtree/after,~/.vim/bundle/coc.nvim/after
set shiftwidth=4
...
wincmd w
argglobal
if bufexists("Animate.lua") | buffer Animate.lua | else | edit Animate.lua | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
